...
input_frame = Frame(win, width=312, height=80, bd=0, highlightbackground="green", highlightcolor="Red",highlightthickness=2)
input_frame.pack(side=TOP)
input_field = Entry(input_frame, font=('arial', 21, 'bold'), textvariable=input_text, width=50, bg="white", bd=0,justify=RIGHT)
input_field.grid(row=0, column=0)
input_field.pack(ipady=10)
btns_frame = Frame(win, width=312, height=300.5, bg="RED")
btns_frame.pack()
